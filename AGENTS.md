...
2. **Implementar engram-ai** — tarea extra antes de empezar con la creación de la app.
3. Sprint 1 — Setup + Auth (registro email + Google OAuth, schema `profiles` + `categories`). Detalle en [`docs/plan-desarrollo.md`](docs/plan-desarrollo.md).
