...
| Pág | Sección |
|---|---|
| 1 | Portada — Botanic + claim |
| 2 | La idea: problema vs solución |
| 3 | El mercado: stats + competencia |
| 4 | Cómo funciona: 3 pasos |
| 5 | Plataforma: PWA → App nativa |
| 6 | Difusión pre-lanzamiento |
| 7 | Difusión post-lanzamiento |
| 8 | Monetización: 3 planes |
| 9 | Roadmap 2026-2028 |
| 10 | Cita inspiracional |
| 11 | Contacto |
| 12 | Back cover |
